...
<head>
  ...
  <script>
    ...
    function loadImages(runner) {
      ...
      for (var i = numImages - 1; i >= 0; i--) {
        ...
        runner.images[imgSource.name] = document.getElementById(imgSource.id);
      }
      init(runner);
    }
    function init(runner) {
      ...
      runner.containerEl.className = Runner.classes.CONTAINER; // Player canvas container.
      ...
      Runner.updateCanvasScaling(runner.canvas); // Horizon contains clouds, obstacles and the ground.
      runner.horizon = new Horizon(runner.canvas, runner.images, runner.dimensions, runner.config.GAP_COEFFICIENT); // Distance meter
      runner.distanceMeter = new DistanceMeter(runner.canvas, runner.images.TEXT_SPRITE, runner.dimensions.WIDTH); // Draw t-rex
      runner.tRex = new Trex(runner.canvas, runner.images.TREX); // ✅ خط تکراری حذف شد
      runner.outerContainerEl.appendChild(runner.containerEl);
      // 2. When the game is fully loaded and ready to play:
    ...
    Runner.prototype = {
      ...
      adjustDimensions: function () {
        ...
        if (this.canvas) {
          // 🛑 شرط توقف کامل رندر Canvas هنگام Game Over Remix
      ...
      update: function (opt_frameTime) {
        ...
        if (this.crashed && sdkActive) {
          this.stop();
          return; // از اجرای بقیه تابع update جلوگیری می‌کند.
        }
        // -----------------------------------------------------------
      ...
      startListening: function () {
        ...
        if (IS_MOBILE) {
          // 🛑 اضافه شدن لمس سراسری برای خاموش شدن با stopListening
        ...
        if (e.target != this.detailsButton) {
          if (!this.crashed && (Runner.keycodes.JUMP[String(e.keyCode)] || e.type == Runner.events.TOUCHSTART)) {
            ...
            if (!this.tRex.jumping) {
              ...
              // 4. Add haptic feedback for jumping:
              if (window.FarcadeSDK && window.FarcadeSDK.singlePlayer) {
                window.FarcadeSDK.singlePlayer.actions.hapticFeedback();
              } // <-- این دو خط جدید را اینجا اضافه کنید
        ...
        const triggerRemixGameOver = () => {
          try {
            if (window.FarcadeSDK && window.FarcadeSDK.singlePlayer && window.FarcadeSDK.singlePlayer.actions) {
              ...
              window.FarcadeSDK.singlePlayer.actions.hapticFeedback();
              console.log("🎮 Remix GameOver sent with score:", scoreValue);
              return true;
            }
          } catch (err) {
      ...
      playSound: function (soundBuffer) {
        if (this.isMuted) {
          // <-- خط جدید برای بررسی وضعیت Mute
          return; // اگر Muted بود، بلافاصله خارج شو
        }
    ...
    Horizon.prototype = {
      ...
      addNewObstacle: function (currentSpeed) {
        ...
        this.obstacles.push(
          new Obstacle(this.canvasCtx, obstacleType, obstacleImg, this.dimensions, this.gapCoefficient, currentSpeed),
        );
      },
      reset: function () {
        this.obstacles = [];
  ...
  <style>
                /* این بخش برای اطمینان از پوشش کامل صفحه است */
        html, body {
            width: 100%;
            height: 100%;
            margin: 0;           /* حذف حاشیه پیش‌فرض مرورگر */
            padding: 0;          /* حذف پدینگ پیش‌فرض مرورگر */
            box-sizing: border-box; /* **تغییر جدید: برای رفع محاسبات مرزی احتمالی** */
            overflow: hidden;    /* کلید اصلی: جلوگیری از نمایش اسکرول در هر دو جهت */
            user-select: none;   /* جلوگیری از انتخاب متن با لمس (مناسب برای بازی‌های موبایل) */
        }
            a {
                color: #585858;
            }
...
<body id="t">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div class="onlyforchrome" style="font-size: 30px; text-align: center; font-family: Helvetica">Running Pengu!</div>
    <div
      class="onlyforchrome"
      style="
        margin-top: 5px;
    ...
    <div id="offline-resources" jstcache="0">
      <div id="offline-resources-1x" jstcache="0">
        ...
        <img
          id="1x-trex"
          src="data:image/png;base64,"
          jstcache="0"
        />
        <img
          id="1x-restart"
      ...
      <div id="offline-resources-2x" jstcache="0">
        ...
        <img
          id="2x-trex"
          src="data:image/png;base64,"
          jstcache="0"
        />
        <img
          id="2x-restart"
